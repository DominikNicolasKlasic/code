...
public class PersonContainer {
	...
	public void addCustomer(Customer c) {
		if(persons.contains(c)) {
			System.out.println("The customer you tired to add to the list, already exists.");
		} else {
			persons.add(c);
			System.out.println("The customer: " + "'" + c.getName() + "'" + " was added to the list.");
		}
	}
		
	public void addWorker(Worker w) {
			if(persons.contains(w)) {
				System.out.println("The worker you tired to add to the list, already exists.");
			} else {
				persons.add(w);
				System.out.println("The worker: " + "'" + w.getName() + "'" + " was added to the list.");
			}	
	}
